...
public class MountControllerC : MonoBehaviour {
	...
	public void GetOn(){
		...
		if(player.GetComponent<PlayerInputControllerC>()){
			if(player.GetComponent<PlayerInputControllerC>().joyStick){
				joyStick = player.GetComponent<PlayerInputControllerC>().joyStick;
			}
		}
